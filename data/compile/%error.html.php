...
<table class="container_0">
	...
	<tr>
		...
		<td class="middlecenter">
				<div class="bbs_position"><span>当前位置:</span> <a href="/bbs/index.html"><? if (!isset($this->magic_vars['_G']['system']['con_webname'])) $this->magic_vars['_G']['system']['con_webname'] = ''; echo $this->magic_vars['_G']['system']['con_webname']; ?></a> -> <span>操作提示</span></div>
