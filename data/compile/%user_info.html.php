...
<div class="wrap950 ">
	...
	<div class="user_right">
		<div class="user_right_menu">
			...
			<ul>
				<li class="title" ><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>">安全信息</a></li>
				...
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="protection"): ?> class="current"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/protection">密码保护</a></li>
			</ul>
			...
			<ul>
				<li class="title" ><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>">好友管理</a></li>
				<li <? if (!isset($this->magic_vars['_U']['query_type'])) $this->magic_vars['_U']['query_type']=''; ;if (  $this->magic_vars['_U']['query_type']=="reginvite"): ?> class="current"<? endif; ?>><a href="<? if (!isset($this->magic_vars['_U']['query_url'])) $this->magic_vars['_U']['query_url'] = ''; echo $this->magic_vars['_U']['query_url']; ?>/reginvite">邀请好友</a></li>
...
每月结算已付费的VIP提成，通过网站充值方式打到您的账上。 <br />
		...
		<div class="user_right_border">
			...
			<div class="c">
				<textarea cols="40" rows="3" id="invite">http://<? if (!isset($_SERVER['SERVER_NAME'])) $_SERVER['SERVER_NAME'] = ''; echo $_SERVER['SERVER_NAME']; ?>/index.php?user&q=action/reginvite&u=<? if (!isset($this->magic_vars['_U']['user_inviteid'])) $this->magic_vars['_U']['user_inviteid'] = ''; echo $this->magic_vars['_U']['user_inviteid']; ?></textarea> <input type="button" onclick="doCopy('invite')" value="复制" />
			</div>
		</div><br /><br />
...
?>
	...
	<div class="user_right_border">
		...
		<div class="user_right_border">
			<div class="e"></div>
			<div class="c">
				<? if (!isset($this->magic_vars['_G']['user_result']['use_money'])) $this->magic_vars['_G']['user_result']['use_money']=''; ;if (  $this->magic_vars['_G']['user_result']['use_money']>=0): ?><input type="submit" name="name"  value="确认提交" size="30" /> <? else: ?> 您的余额为<? if (!isset($this->magic_vars['_G']['user_result']['use_money'])) $this->magic_vars['_G']['user_result']['use_money'] = ''; echo $this->magic_vars['_G']['user_result']['use_money']; ?>,请先 <a href="/index.php?user&q=code/account/recharge_new"><font color="#FF0000">充值</font></a>。<? endif; ?>
			</div>
		</div>
		</form><? endif; ?>
		<div class="user_right_foot">
		* 温馨提示：我们将严格对用户的所有资料进行保密
		...
		<div class="user_right_border">
			<div class="c">
				<form action="" method="post">手机号码：<input type="text" name="phone" value="<? if (!isset($this->magic_vars['_G']['user_result']['phone_status'])) $this->magic_vars['_G']['user_result']['phone_status']='';if (!isset($this->magic_vars['_G']['user_result']['phone_status'])) $this->magic_vars['_G']['user_result']['phone_status']=''; ;if (  $this->magic_vars['_G']['user_result']['phone_status']==0 ||   $this->magic_vars['_G']['user_result']['phone_status']==1): ?><? if (!isset($this->magic_vars['_G']['user_result']['phone'])) $this->magic_vars['_G']['user_result']['phone'] = ''; echo $this->magic_vars['_G']['user_result']['phone']; ?><? else: ?><? if (!isset($this->magic_vars['_G']['user_result']['phone_status'])) $this->magic_vars['_G']['user_result']['phone_status'] = ''; echo $this->magic_vars['_G']['user_result']['phone_status']; ?><? endif; ?>" /> <input type="submit" value="确认提交" /><br /><br /></form>
