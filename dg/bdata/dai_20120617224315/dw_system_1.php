...
E_D("replace into `dw_system` values('3','网站名称','con_webname','揭阳市金兰芬投资有限公司','0','1','0');");
E_D("replace into `dw_system` values('4','网站网址','con_weburl','http://www.jinlanfen.com','0','1','0');");
E_D("replace into `dw_system` values('5','网站路径','con_webpath','','0','1','0');");
E_D("replace into `dw_system` values('6','网站logo','con_logo','','3','1','0');");
E_D("replace into `dw_system` values('7','网站关键词','con_keywords','揭阳市个人网络信用 无抵押贷款 无抵押 无担保 小额贷款 投资理财 企业融资','0','1','0');");
E_D("replace into `dw_system` values('8','网站描述','con_description','金兰芬网贷是揭阳市金兰芬投资有限公司投资建立的本土网上贷款平台，服务于揭阳市民的小额贷款需要。愿揭阳全市人人有钱贷，事业人人有成。','0','1','0');");
E_D("replace into `dw_system` values('9','网站位置分隔符','con_position',' ->','0','1','0');");
E_D("replace into `dw_system` values('10','网站备案号','con_beian','粤ICP备10205408号-1','0','1','0');");
E_D("replace into `dw_system` values('11','网站统计','con_tongji','<script language=\"javascript\" type=\"text/javascript\" src=\"http://js.users.51.la/5714971.js\"></script>','2','1','0');");
...
E_D("replace into `dw_system` values('39','邮箱地址','con_email_email','676668697@qq.com','0','4','0');");
E_D("replace into `dw_system` values('40','邮箱密码','con_email_pwd','666268f1221','0','4','0');");
E_D("replace into `dw_system` values('41','发件人Email','con_email_from','676668697@qq.com','0','4','0');");
E_D("replace into `dw_system` values('42','发件人昵称或姓名','con_email_from_name','金兰芬投资借贷平台','0','4','0');");
...
E_D("replace into `dw_system` values('46','联系地址','con_address','广东省揭阳市东山区新河南二区沿街八幢201号','0','1','1');");
...
E_D("replace into `dw_system` values('54','客户中心文字','con_kefutext','欢迎光临金兰芬投资客服中心！<br />\r\n有任何疑问请联系你的专属客服!','2','1','1');");
...
E_D("replace into `dw_system` values('62','后台地址名称','con_houtai','pucms','0','1','1');");
